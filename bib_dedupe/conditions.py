...
au10_ti095_ct10 = (
    f" {match(Fields.CONTAINER_TITLE, Fields.AUTHOR)} & {Fields.TITLE} > 0.95 "
)
...
duplicate_conditions = [
    ...
    f"({au10_ti095_ct10} & {match(Fields.YEAR, Fields.DOI)} & {non_contradicting(Fields.NUMBER, Fields.PAGES)})",
