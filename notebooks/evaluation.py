...
def add_external_evaluations(dataset_df: pd.DataFrame) -> pd.DataFrame:
    ...
    performance_data_depression["false_positive_rate"] = performance_data_depression[
        "FP"
    ...
    performance_data_cardiac["false_positive_rate"] = performance_data_cardiac["FP"] / (
...
def append_to_output(result: dict, *, package_name: str) -> None:
    ...
    with open(output_md_path, "w") as f:
        ...
        for dataset in results_df["dataset"].unique():
            ...
            # dataset_df = add_external_evaluations(dataset_df, dataset)
